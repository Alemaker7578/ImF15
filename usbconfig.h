 ...
 */
 ...
 /* -- Changes made to make device look like an HP keyboard
 * GeekMustHave
 */
 ...
 * the implications!
 */
 /* -- Using the HP Keyboard VID/PID pair to avoid issue with the
  * standard pair being ignored by some Corp Computers.
  * VID=046d PID=c52b
  * GeekMustHave
 */
#define USB_CFG_DEVICE_ID 0x2b, 0xc5
 ...
 */
#define USB_CFG_VENDOR_NAME     'h','p'
 ...
 * details.
 */
/* -- to avoid issue chaning vendor name to 'hp'
 *    adjust length to 2
 * GeekMustHave
*/
 ...
 */
/* --- To avoid issue changing device name to 'keyboard'
 *     adjust the length to 8
 * GeekMustHave
 */ 
